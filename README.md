...
- A custom WordPress toolkit plugin with settings, shortcodes, a portfolio custom post type, REST API output, JavaScript API rendering, Google Tag Manager support, and WooCommerce awareness
